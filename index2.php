            ...
            <div class="container-fluid dark">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="store.php">SHOP<span class="glyphicon glyphicon-shopping-cart"></a></li>
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    ...
                    <div class="carousel-caption dark cbrand">
                        ...
                        <h1 class="text-center"><a href="store.php" class="btn btn-dark btn-lg btechbutton">DON'T MISS
                                OUT <span class="glyphicon glyphicon-shopping-cart"></span></a>
                        </h1>
                ...
                <div class="item">
                    ...
                    <div class="carousel-caption dark cbrand">
                        ...
                        <h1 class="text-center"><a href="store.php" class="btn btn-dark btn-lg btechbutton">SHOP NOW
                ...
                <div class="item">
                    ...
                    <div class="carousel-caption dark cbrand">
                        ...
                        <h1 class="text-center"><a href="store.php" class="btn btn-dark btn-lg btechbutton">GET IT WITH
                                AN OFFER <span class="glyphicon glyphicon-shopping-cart"></span></a>
                ...
                <div class="item">
                    ...
                    <div class="carousel-caption dark cbrand">
                        <h6 class="text-center text-uppercase">Electronics</h6>
                        <h1 class="text-center"><a href="store.php" class="btn btn-dark btn-lg btechbutton">TRY YOUR
                                LUCK <span class="glyphicon glyphicon-shopping-cart"></span></a>
                            <p class="text-muted">Technology pour change</p>
                    </div>
                </div>
                ...
                <div class="item">
                    ...
                    <div class="carousel-caption dark cbrand">
                        ...
                        <h1 class="text-center"><a href="store.php" class="btn btn-dark btn-lg btechbutton">GLAD YOUR
                                HERE <span class="glyphicon glyphicon-shopping-cart"></span></a>
                ...
                <div class="item">
                    ...
                    <div class="carousel-caption dark cbrand">
                        ...
                        <h1 class="text-center"><a href="store.php" class="btn btn-dark btn-lg btechbutton">GET STARTED
                                <span class="glyphicon glyphicon-shopping-cart"></span></a>
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        ...
                        <div class="carousel-caption dark">
                            ...
                            <a href="store.php" class="btn btn-dark btn-sm motorbtn">More</a>
                        </div>
                    </div>
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        ...
                        <div class="carousel-caption dark">
                            ...
                            <a href="store.php" class="btn btn-dark btn-sm electrobtn">More</a>
                        </div>
                    </div>
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        ...
                        <div class="carousel-caption dark">
                            ...
                            <h6>Cost :40,000KSH</h6>
                            <p class="text-info">Technology pour change</p>
                            <a href="store.php" class="btn btn-dark btn-sm sportsbtn">More</a>
                        </div>
                    </div>
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        ...
                        <div class="carousel-caption dark">
                            ...
                            <h6>Cost :3,000KSH</h6>
                            <p class="text-info">Horsepower sells cars but torque power wins races</p>
                            <a href="store.php" class="btn btn-dark btn-sm fashionbtn">More</a>
                        </div>
                    </div>
